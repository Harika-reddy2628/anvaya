...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={cn(
        "font-sans antialiased scroll-smooth selection:bg-[#F59E0B]/20 selection:text-[#F59E0B]",
    ...
    >
      ...
      <body className="min-h-screen bg-[#07080D] text-[#F8FAFC] flex flex-col font-sans">
        {children}
      </body>
    </html>
  );
